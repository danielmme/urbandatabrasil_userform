...
/**
 * Provides a 'refEspacialSPUni' migrate process plugin.
 *
 * @MigrateProcessPlugin(
 *  id = "prepare_multiple_paragraphs_uni"
 * )
 */
class refEspacialSPUni extends ProcessPluginBase {
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    ...
    $paragraphs = [];
    $query = $connection->select('migrate_map_urbandata_paragraphs_sp_unificado', 'yt');
